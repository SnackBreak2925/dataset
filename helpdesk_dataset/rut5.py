...
questions = [
    ...
    "тест",
    "Добрый день! Мы получили 13 новых компьютеров от учебного управления, и ввода их в эксплуатацию нам требуется лицензии для операционной системы, а так же для сопутствующего ПО",
]
